...
class Car():
    """Representando um carro com Programação
     orientada a objetos."""
...
class Batery():
    ...
    def __init__(self,
                 Nivel_Bateria=95):  # Aqui só se aceitava os valores 80 e 95 para o codigo funcionar. Eu melhorei o Codigo
...
class ElectricCar(Car):
    ...
    def __init__(self, make, model, year):
        ...
        self.Bateria_ = Batery()  # Este Atrib recebe a Classe Batery (Que esta com o Valor Defalt de 80)
